...
cljff.setSwitchingFunction( HarmonicSwitchingFunction(7.5*angstrom,7.5*angstrom) )
...
cljff2 = InterGroupCLJFF("cljff2")
cljff2.setSwitchingFunction( HarmonicSwitchingFunction(30*angstrom, 30*angstrom) )
cljff2.add(swapwaters, MGIdx(0))
cljff2.add(waters, MGIdx(1))
cljff2.setShiftElectrostatics(True)
#cljff2.setUseAtomisticCutoff(True)
#cljff2.setUseReactionField(True)
