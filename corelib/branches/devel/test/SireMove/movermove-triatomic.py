...
#
# Compute the distribution of bonds & angle in a triatomic molecule using the MoverMove method
# The results should be identical to those obtained with zmatmove-triatomic.py and the total energy 
# of the system should be close to 0.8886 kcal.mol-1 (equipartition theorem)
...
solute_mover_moves.setBonds(solute.property('connectivity').getBonds())
solute_mover_moves.setAngles(solute.property('connectivity').getAngles())
