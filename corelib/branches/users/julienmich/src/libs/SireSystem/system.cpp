...
void System::energyTable(EnergyTable &energytable, double scale_energy)
{
    this->_pvt_forceFields().energyTable(energytable, scale_energy);
}

void System::energyTable(EnergyTable &energytable, const Symbol &component,
                         double scale_energy)
{
    this->_pvt_forceFields().energyTable(energytable, component, scale_energy);
}
