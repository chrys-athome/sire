...
/** Return the parent Viewer of this canvas */
const Viewer* GLCanvas::parent() const
{
    return prnt;
}
...
void GLCanvas::setMoveMode(bool on)
{
    movemode = on;
