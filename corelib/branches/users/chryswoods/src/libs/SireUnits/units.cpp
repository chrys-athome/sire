...
const Dimension::Angle radians( radian );

const Dimension::Angle degree = radians * pi / 180.0;
const Dimension::Angle degrees(degree);
...
const Dimension::Angle angle_seconds(angle_seconds);
...
const Dimension::Length bohr_radius(bohr_radii);
...
const Dimension::Mass grams(gram);
const Dimension::Mass kilogram( 1000 * gram );
const Dimension::Mass kilograms(kilogram);
const Dimension::Mass tonne( 1000 * kilogram );
const Dimension::Mass tonnes(tonne);

const Dimension::Mass milligram( 0.001 * gram );
const Dimension::Mass milligrams(milligram);
const Dimension::Mass microgram( 0.001 * milligram );
const Dimension::Mass micrograms(microgram);
const Dimension::Mass nanogram( 0.001 * microgram );
const Dimension::Mass nanograms(nanogram);
const Dimension::Mass picogram( 0.001 * nanogram );
const Dimension::Mass picograms(picogram);
const Dimension::Mass femtogram( 0.001 * picogram );
const Dimension::Mass femtograms(femtogram);
...
const Dimension::Charge mod_electrons(mod_electron);
const Dimension::MolarCharge faraday(1);
const Dimension::MolarCharge faradays(faraday);
...
const Dimension::Charge coulombs(coulomb);
const Dimension::MolarCharge coulombs_per_mol = coulomb / mole;
...
const Dimension::Energy hartrees(hartree);
...
const Dimension::Time seconds(second);
const Dimension::Time millisecond = 0.001 * second;
const Dimension::Time milliseconds(millisecond);
const Dimension::Time microsecond = 0.001 * millisecond;
const Dimension::Time microseconds(microsecond);
const Dimension::Time nanosecond = 0.001 * microsecond;
const Dimension::Time nanoseconds(nanosecond);
const Dimension::Time picosecond = 0.001 * nanosecond;
const Dimension::Time picoseconds(picosecond);
const Dimension::Time femtosecond = 0.001 * picosecond;
const Dimension::Time femtoseconds(femtosecond);

const Dimension::Time minute( 60 * second );
const Dimension::Time minutes(minute);
const Dimension::Time hour( 60 * minute );
const Dimension::Time hours(hour);
const Dimension::Time day( 24 * hour );
const Dimension::Time days(day);
const Dimension::Time week( 7 * day );
const Dimension::Time weeks(week);
const Dimension::Time fortnight( 2 * week );
const Dimension::Time fortnights(fortnight);
...
const Dimension::Force newtons(newton);

/** Weights */
const Dimension::Force ounce = 0.27801385095 * newton;
const Dimension::Force ounces(ounce);
const Dimension::Force pound = 16 * ounce;
const Dimension::Force pounds(pound);
const Dimension::Force stone = 14 * pound;
const Dimension::Force stones(stone);
...
const Dimension::Pressure pascals(pascal);
...
const Dimension::Current amps(amp);

/** Volts */
const Dimension::Potential volt = joule / coulomb;
const Dimension::Potential volts(volt);

/** Convert the units of capacitance (farads) */
const Dimension::Capacitance farad = coulomb / volt;
const Dimension::Capacitance farads(farad);

/** Convert power in Watts */
const Dimension::Power watt = joule / second;
const Dimension::Power watts(watt);
const Dimension::MolarPower watts_per_mol = J_per_mol / second;
