...
#ifndef SIREN_STREAMPOLYPOINTER_HPP
#define SIREN_STREAMPOLYPOINTER_HPP
...
#include "Siren/detail/sharedpolypointer.hpp"
...
void savePolyPointer(QDataStream &ds, const boost::shared_ptr<T> &ptr)
{
    ...
    else
    {
        ...
        const char* objname = Siren::SharedPolyPointerHelper<T>::what(*(ptr.get()))
