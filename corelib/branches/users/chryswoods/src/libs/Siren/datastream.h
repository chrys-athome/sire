...
// allow Siren objects to be serialised to a binary 
// datastream
//
...
class SIREN_EXPORT SharedDataHolder
{
public:
    SharedDataHolder();
...
template<class T>
class SIREN_EXPORT SharedDataHolderT : public SharedDataHolder
{
public:
...
/** This class is used by DataStream to provide a registry of shared
    objects that have either been read or written already (and so don't
    need reading or writing again)
    
    @author Christopher Woods
*/
class SIREN_EXPORT SharedDataRegistry
{
public:
...
@author
*/
class SIREN_EXPORT DataStream : public boost::noncopyable
{
public:
    DataStream();
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::standardSave(const T &value)
{
    this->ds << value;
}
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::standardLoad(T & value)
{
    this->ds >> value;
}
...
template<class T, class GETPOINTER>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::sharedSave(const T &value)
{
...
template<class T, class GETPOINTER>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::sharedLoad(T &value, const T &default_value)
{
    this->readVersion();
...
template<class T, class GETPOINTER>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::sharedLoad(T &value)
{
...
template<class T, class GETPOINTER>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::sharedLoadPointer(T &pointer)
{
    this->readVersion();
...
template<class T, class GETPOINTER>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::sharedSavePointer(const T &pointer)
{
...
template<class T, class GETPOINTER>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::sharedLoadContainer(T &container)
{
    this->readVersion();
...
template<class T, class GETPOINTER>
SIREN_OUTOFLINE_TEMPLATE
void DataStream::sharedSaveContainer(const T &container)
{
    this->sharedSave<T,GETPOINTER>(container);
}

//////////
////////// DataStream serialisation operators
//////////

template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator<<(DataStream &sds, 
...
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator<<(DataStream &sds, 
                       const detail::SharedPolyPointer<T> &objptr)
{
    sds.sharedSave< detail::SharedPolyPointer<T>,
                    detail::GetSharedPolyPointer< 
                            detail::SharedPolyPointer<T> > >(objptr);
...
DataStream& operator>>(DataStream &sds, 
                       detail::SharedPolyPointer<T> &objptr)
{
    sds.sharedLoad< detail::SharedPolyPointer<T>,
                    detail::GetSharedPolyPointer< 
                                detail::SharedPolyPointer<T> > >(objptr);
...
DataStream& operator<<(DataStream &sds, const QString &str);
DataStream& operator>>(DataStream &sds, QString &str);
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& sharedSaveContainer(DataStream &sds, const T &container)
{
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& sharedLoadContainer(DataStream &sds, T &container)
{
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator<<(DataStream &sds, const QList<T> &list)
{
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator>>(DataStream &sds, QList<T> &list)
{
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator<<(DataStream &sds, const QVector<T> &vector)
{
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator>>(DataStream &sds, QVector<T> &vector)
{
...
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator<<(DataStream &sds, const QHash<Key,T> &hash)
{
...
template<class Key, class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator>>(DataStream &sds, QHash<Key,T> &hash)
{
...
template<class Key, class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator<<(DataStream &sds, const QMap<Key,T> &map)
{
...
template<class Key, class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator>>(DataStream &sds, QMap<Key,T> &map)
{
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator<<(DataStream &sds, const T &value)
{
...
template<class T>
SIREN_OUTOFLINE_TEMPLATE
DataStream& operator>>(DataStream &sds, T &value)
{
