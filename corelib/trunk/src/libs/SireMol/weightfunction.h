...
public:
    ...
    void addToA(const AtomVector &atoms);
    void addToB(const AtomVector &atoms);
...
inline boost::any WeightCalculator::getValue(const QString &name, const boost::any &devault) const
{
