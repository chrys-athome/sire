...
public:
   ...
   ///// Query functions //////////////////////////
    ...
    BondList bonds(const AtomIndex &atom) const;
   ...
   //// Editing functions /////////////////////////
    ...
    void add(const AtomSet &atoms);
    void add(const AtomList &atoms);
    void add(const AtomVector &atoms);
    
    void remove(const AtomIndex &atm);
    void remove(const AtomIndexSet &atoms);
    void remove(const AtomIndexList &atoms);
    
    void add(const Bond &bond);
    void remove(const Bond &bond);

    void add(const BondList &bonds);
    void remove(const BondList &bonds);
