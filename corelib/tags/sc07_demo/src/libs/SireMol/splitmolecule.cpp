                ...
                const AtomIDGroup &exclude, AtomIDGroup &group)
{
    ...
    QList<Bond> intrabnds = connectivity.intraBonds(start.name());
                   ...
                   const AtomIDGroup &exclude, AtomIDGroup &group)
{
    ...
    QList<Bond> interbnds = connectivity.residue(startres).interBonds();
                ...
                const AtomIDGroup &exclude, AtomIDGroup &group)
{
    ...
    QList<Bond> intrabnds = resbnds.intraBonds(start.name());
    ...
    QList<Bond> interbnds = resbnds.interBonds(start.name());
