...
namespace Siren
{
    ...
    */
    ...
    public:    
        ...
        bool isA(const Qt::String &type_name) const;
        ...
        void assertIsA(const Qt::String &type_name) const;
        ...
        virtual Qt::String toString() const;

        TestReport test() const throw();
        TestReport stressTest() const throw();

        Qt::String docString() const;
        Qt::String docString(const Qt::String &function) const;
    ...
    private:
        void throwInvalidCast(const Qt::String &type_name) const;
    };
