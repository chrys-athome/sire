    ...
    namespace detail
    {
        ...
        */
        ...
        public:
            ...
            static Class getClass(const Qt::String &type_name);
            
            static Qt::StringList registeredClasses();
        ...
        private:
            ...
            Qt::ReadWriteLock *lock;
            Qt::List<const ClassData*>::Type *registry;
        ...
        */
        ...
        public:
            ...
            const Qt::String& typeName() const;
            const Qt::String& baseTypeName() const;
        
            int version() const;
        
            const Qt::StringList& interfaces() const;
        ...
        private:
            ...
            Qt::AtomicPointer<Qt::String>::Type type_name_string;
            
            /** This is a cache of the base name of the class */
            Qt::AtomicPointer<Qt::String>::Type base_name_string;
            
            /** This is a cache of the interfaces supported by this 
                class - this is 0 if there are no interfaces */
            Qt::AtomicPointer<Qt::StringList>::Type ifaces_list;
