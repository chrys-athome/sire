...
namespace Siren
{
    ...
    public:
        TestReportItem();
        TestReportItem(const String &description);
    ...
    public:
        TestPassedItem();
        TestPassedItem(const String &description);
    ...
    public:
        TestFailedItem();
        TestFailedItem(const String &description);
    ...
    public:
        ...
        TestFailedExceptionItem(const Exception &e, const String &description);
    ...
    */
    ...
    public:
        ...
        TestReport(const String &description);
        TestReport(const Class &c);
        TestReport(const Class &c, const String &description);
    ...
    */
    ...
    public:
        ...
        TestReportEditor& addFailed(const String &description);
        TestReportEditor& addFailure(const String &description);

        TestReportEditor& addException(const Exception &e);
        TestReportEditor& addException(const Exception &e, const String &description);
        ...
        TestReportEditor& testEqual(double i0, double i1, 
                                    const String &description, double tol=1.0e-6);
                       
        TestReportEditor& testEqual(int i0, int i1, const String &description);
