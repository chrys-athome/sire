...
void register_AtomForces_class(){
    ...
    { //::SireMol::AtomProperty< SireMaths::Vector3D< SireUnits::Dimension::PhysUnit< 1, 1, -0x000000002, 0, 0, 0, 0 > > >
        ...
        AtomForces_exposer.def( bp::init< SireMol::MoleculeInfoData const &, SireMaths::Vector3D< SireUnits::Dimension::PhysUnit< 1, 1, -0x000000002, 0, 0, 0, 0 > > const & >(( bp::arg("molinfo"), bp::arg("default_value") )) );
