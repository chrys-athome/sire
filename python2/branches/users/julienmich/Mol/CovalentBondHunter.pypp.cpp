...
void register_CovalentBondHunter_class(){
    ...
    { //::SireMol::CovalentBondHunter
        ...
        CovalentBondHunter_exposer_t CovalentBondHunter_exposer = CovalentBondHunter_exposer_t( "CovalentBondHunter", bp::init< bp::optional< double > >(( bp::arg("tolerance")=1.10000000000000008881784197001252323389053344727e+0 )) );
