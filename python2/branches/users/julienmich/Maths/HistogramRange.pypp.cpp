...
void register_HistogramRange_class(){
    ...
    { //::SireMaths::HistogramRange
        ...
        HistogramRange_exposer.def( "__rlshift__", &__rlshift__QDataStream< ::SireMaths::HistogramRange >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        HistogramRange_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::HistogramRange >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
