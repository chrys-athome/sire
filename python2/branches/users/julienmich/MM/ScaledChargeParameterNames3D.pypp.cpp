...
void register_ScaledChargeParameterNames3D_class(){
    ...
    { //::SireMM::ScaledChargeParameterNames3D
        ...
        ScaledChargeParameterNames3D_exposer_t ScaledChargeParameterNames3D_exposer = ScaledChargeParameterNames3D_exposer_t( "ScaledChargeParameterNames3D" );
        bp::scope ScaledChargeParameterNames3D_scope( ScaledChargeParameterNames3D_exposer );
        ScaledChargeParameterNames3D_exposer.def( bp::init< >() );
