...
void register_IntraGroupLJFF_class(){
    ...
    { //::SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >
        ...
        IntraGroupLJFF_exposer_t IntraGroupLJFF_exposer = IntraGroupLJFF_exposer_t( "IntraGroupLJFF" );
        bp::scope IntraGroupLJFF_scope( IntraGroupLJFF_exposer );
        IntraGroupLJFF_exposer.def( bp::init< >() );
        ...
        { //::SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >::energyTable
        
            typedef SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > > exported_class_t;
            typedef void ( ::SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >::*energyTable_function_type )( ::SireFF::EnergyTable &,double ) ;
            energyTable_function_type energyTable_function_value( &::SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >::energyTable );
        ...
        { //::SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >::energyTable
            ...
            typedef SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > > exported_class_t;
            typedef void ( ::SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >::*energyTable_function_type )( ::SireFF::EnergyTable &,::SireCAS::Symbol const &,double ) ;
            energyTable_function_type energyTable_function_value( &::SireFF::Intra2B2G3DFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >::energyTable );
