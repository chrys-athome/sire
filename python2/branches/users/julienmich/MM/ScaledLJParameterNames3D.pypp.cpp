...
void register_ScaledLJParameterNames3D_class(){
    ...
    { //::SireMM::ScaledLJParameterNames3D
        ...
        ScaledLJParameterNames3D_exposer_t ScaledLJParameterNames3D_exposer = ScaledLJParameterNames3D_exposer_t( "ScaledLJParameterNames3D" );
        bp::scope ScaledLJParameterNames3D_scope( ScaledLJParameterNames3D_exposer );
        ScaledLJParameterNames3D_exposer.def( bp::init< >() );
