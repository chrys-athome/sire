...
void register_IntraSoftCLJFF_class(){
    ...
    { //::SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > >
        ...
        IntraSoftCLJFF_exposer_t IntraSoftCLJFF_exposer = IntraSoftCLJFF_exposer_t( "IntraSoftCLJFF" );
        bp::scope IntraSoftCLJFF_scope( IntraSoftCLJFF_exposer );
        IntraSoftCLJFF_exposer.def( bp::init< >() );
        ...
        { //::SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > >::energyTable
        
            typedef SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > > exported_class_t;
            typedef void ( ::SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > >::*energyTable_function_type )( ::SireFF::EnergyTable &,double ) ;
            energyTable_function_type energyTable_function_value( &::SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > >::energyTable );
        ...
        { //::SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > >::energyTable
            ...
            typedef SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > > exported_class_t;
            typedef void ( ::SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > >::*energyTable_function_type )( ::SireFF::EnergyTable &,::SireCAS::Symbol const &,double ) ;
            energyTable_function_type energyTable_function_value( &::SireFF::Intra2B3DFF< SireMM::SoftCLJPotentialInterface< SireMM::IntraSoftCLJPotential > >::energyTable );
