...
void register_ScaledCLJParameterNames3D_class(){
    ...
    { //::SireMM::ScaledCLJParameterNames3D
        ...
        ScaledCLJParameterNames3D_exposer_t ScaledCLJParameterNames3D_exposer = ScaledCLJParameterNames3D_exposer_t( "ScaledCLJParameterNames3D" );
        bp::scope ScaledCLJParameterNames3D_scope( ScaledCLJParameterNames3D_exposer );
        ScaledCLJParameterNames3D_exposer.def( bp::init< >() );
