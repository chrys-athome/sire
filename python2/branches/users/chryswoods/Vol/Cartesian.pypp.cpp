...
void register_Cartesian_class(){
    ...
    { //::SireVol::Cartesian
        typedef bp::class_< SireVol::Cartesian, bp::bases< SireVol::Space, Siren::Object > > Cartesian_exposer_t;
        ...
        { //::SireVol::Cartesian::hashCode
        
            typedef ::uint ( ::SireVol::Cartesian::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireVol::Cartesian::hashCode );
        ...
        { //::SireVol::Cartesian::stream
        
            typedef void ( ::SireVol::Cartesian::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireVol::Cartesian::stream );
        ...
        { //::SireVol::Cartesian::test
        
            typedef bool ( ::SireVol::Cartesian::*test_function_type )( ::Siren::Logger & ) const;
            test_function_type test_function_value( &::SireVol::Cartesian::test );
