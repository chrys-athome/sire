...
void register_PeriodicBox_class(){
    ...
    { //::SireVol::PeriodicBox
        typedef bp::class_< SireVol::PeriodicBox, bp::bases< SireVol::Cartesian, SireVol::Space, Siren::Object > > PeriodicBox_exposer_t;
        ...
        { //::SireVol::PeriodicBox::hashCode
        
            typedef ::uint ( ::SireVol::PeriodicBox::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireVol::PeriodicBox::hashCode );
        ...
        { //::SireVol::PeriodicBox::stream
        
            typedef void ( ::SireVol::PeriodicBox::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireVol::PeriodicBox::stream );
        ...
        { //::SireVol::PeriodicBox::test
        
            typedef bool ( ::SireVol::PeriodicBox::*test_function_type )( ::Siren::Logger & ) const;
            test_function_type test_function_value( &::SireVol::PeriodicBox::test );
