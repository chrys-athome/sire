...
void register_CoordGroupBase_class(){
    ...
    { //::SireVol::CoordGroupBase
        typedef bp::class_< SireVol::CoordGroupBase, bp::bases< Siren::Object >, boost::noncopyable > CoordGroupBase_exposer_t;
        ...
        { //::SireVol::CoordGroupBase::nCoords
        
            typedef int ( ::SireVol::CoordGroupBase::*nCoords_function_type )(  ) const;
            nCoords_function_type nCoords_function_value( &::SireVol::CoordGroupBase::nCoords );
        ...
        { //::SireVol::CoordGroupBase::stream
        
            typedef void ( ::SireVol::CoordGroupBase::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireVol::CoordGroupBase::stream );
