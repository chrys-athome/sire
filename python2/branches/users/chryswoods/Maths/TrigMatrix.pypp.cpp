...
void register_TrigMatrix_class(){
    ...
    { //::SireMaths::TrigMatrix
        typedef bp::class_< SireMaths::TrigMatrix, bp::bases< Siren::Mutable, Siren::Object > > TrigMatrix_exposer_t;
        ...
        { //::SireMaths::TrigMatrix::hashCode
        
            typedef ::uint ( ::SireMaths::TrigMatrix::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireMaths::TrigMatrix::hashCode );
        ...
        { //::SireMaths::TrigMatrix::stream
        
            typedef void ( ::SireMaths::TrigMatrix::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireMaths::TrigMatrix::stream );
