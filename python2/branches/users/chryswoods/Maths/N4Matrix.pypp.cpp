...
void register_N4Matrix_class(){
    ...
    { //::SireMaths::N4Matrix
        typedef bp::class_< SireMaths::N4Matrix, bp::bases< Siren::Mutable, Siren::Object > > N4Matrix_exposer_t;
        N4Matrix_exposer_t N4Matrix_exposer = N4Matrix_exposer_t( "N4Matrix" );
        bp::scope N4Matrix_scope( N4Matrix_exposer );
        N4Matrix_exposer.def( bp::init< >() );
        ...
        { //::SireMaths::N4Matrix::hashCode
        
            typedef ::uint ( ::SireMaths::N4Matrix::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireMaths::N4Matrix::hashCode );
        ...
        { //::SireMaths::N4Matrix::stream
        
            typedef void ( ::SireMaths::N4Matrix::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireMaths::N4Matrix::stream );
