...
void register_Vector_class(){
    ...
    { //::SireMaths::Vector
        typedef bp::class_< SireMaths::Vector, bp::bases< Siren::Primitive<SireMaths::Vector> > > Vector_exposer_t;
        ...
        { //::SireMaths::Vector::hashCode
        
            typedef ::uint ( ::SireMaths::Vector::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireMaths::Vector::hashCode );
        ...
        { //::SireMaths::Vector::stream
        
            typedef void ( ::SireMaths::Vector::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireMaths::Vector::stream );
        ...
        { //::SireMaths::Vector::test
        
            typedef bool ( ::SireMaths::Vector::*test_function_type )(  ) const;
            test_function_type test_function_value( &::SireMaths::Vector::test );
        ...
        { //::SireMaths::Vector::test
            ...
            typedef bool ( ::SireMaths::Vector::*test_function_type )( ::Siren::Logger & ) const;
            test_function_type test_function_value( &::SireMaths::Vector::test );
