...
void register_TrigArray2D_Vector__class(){
    ...
    { //::SireBase::TrigArray2D< SireMaths::Vector >
        typedef bp::class_< SireBase::TrigArray2D< SireMaths::Vector >, bp::bases< Siren::Mutable, SireBase::TrigArray2DBase, Siren::Object > > TrigArray2D_Vector__exposer_t;
        TrigArray2D_Vector__exposer_t TrigArray2D_Vector__exposer = TrigArray2D_Vector__exposer_t( "TrigArray2D_Vector_" );
        bp::scope TrigArray2D_Vector__scope( TrigArray2D_Vector__exposer );
        TrigArray2D_Vector__exposer.def( bp::init< >() );
        ...
        { //::SireBase::TrigArray2D< SireMaths::Vector >::stream
        
            typedef SireBase::TrigArray2D< SireMaths::Vector > exported_class_t;
            typedef void ( ::SireBase::TrigArray2D< SireMaths::Vector >::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireBase::TrigArray2D< SireMaths::Vector >::stream );
        ...
        { //::SireBase::TrigArray2D< SireMaths::Vector >::typeName
        
            typedef SireBase::TrigArray2D< SireMaths::Vector > exported_class_t;
            typedef ::QString ( *typeName_function_type )(  );
            typeName_function_type typeName_function_value( &::SireBase::TrigArray2D< SireMaths::Vector >::typeName );
        ...
        TrigArray2D_Vector__exposer.staticmethod( "typeName" );
