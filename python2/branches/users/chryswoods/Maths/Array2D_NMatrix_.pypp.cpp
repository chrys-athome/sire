...
void register_Array2D_NMatrix__class(){
    ...
    { //::SireBase::Array2D< SireMaths::NMatrix >
        typedef bp::class_< SireBase::Array2D< SireMaths::NMatrix >, bp::bases< Siren::Mutable, SireBase::Array2DBase, Siren::Object > > Array2D_NMatrix__exposer_t;
        Array2D_NMatrix__exposer_t Array2D_NMatrix__exposer = Array2D_NMatrix__exposer_t( "Array2D_NMatrix_" );
        bp::scope Array2D_NMatrix__scope( Array2D_NMatrix__exposer );
        Array2D_NMatrix__exposer.def( bp::init< >() );
        ...
        { //::SireBase::Array2D< SireMaths::NMatrix >::stream
        
            typedef SireBase::Array2D< SireMaths::NMatrix > exported_class_t;
            typedef void ( ::SireBase::Array2D< SireMaths::NMatrix >::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireBase::Array2D< SireMaths::NMatrix >::stream );
        ...
        { //::SireBase::Array2D< SireMaths::NMatrix >::typeName
        
            typedef SireBase::Array2D< SireMaths::NMatrix > exported_class_t;
            typedef ::QString ( *typeName_function_type )(  );
            typeName_function_type typeName_function_value( &::SireBase::Array2D< SireMaths::NMatrix >::typeName );
        ...
        Array2D_NMatrix__exposer.staticmethod( "typeName" );
