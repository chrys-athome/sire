...
void register_NVector_class(){
    ...
    { //::SireMaths::NVector
        typedef bp::class_< SireMaths::NVector, bp::bases< Siren::Mutable, Siren::Object > > NVector_exposer_t;
        ...
        { //::SireMaths::NVector::hashCode
        
            typedef ::uint ( ::SireMaths::NVector::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireMaths::NVector::hashCode );
        ...
        { //::SireMaths::NVector::stream
        
            typedef void ( ::SireMaths::NVector::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireMaths::NVector::stream );
