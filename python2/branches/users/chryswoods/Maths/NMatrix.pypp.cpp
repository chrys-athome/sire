...
void register_NMatrix_class(){
    ...
    { //::SireMaths::NMatrix
        typedef bp::class_< SireMaths::NMatrix, bp::bases< Siren::Mutable, Siren::Object > > NMatrix_exposer_t;
        ...
        { //::SireMaths::NMatrix::hashCode
        
            typedef ::uint ( ::SireMaths::NMatrix::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireMaths::NMatrix::hashCode );
        ...
        { //::SireMaths::NMatrix::stream
        
            typedef void ( ::SireMaths::NMatrix::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireMaths::NMatrix::stream );
