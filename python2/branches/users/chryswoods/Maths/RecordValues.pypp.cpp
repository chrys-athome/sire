...
void register_RecordValues_class(){
    ...
    { //::SireMaths::RecordValues
        typedef bp::class_< SireMaths::RecordValues, bp::bases< SireMaths::Accumulator, Siren::Mutable, Siren::Object > > RecordValues_exposer_t;
        ...
        { //::SireMaths::RecordValues::stream
        
            typedef void ( ::SireMaths::RecordValues::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireMaths::RecordValues::stream );
