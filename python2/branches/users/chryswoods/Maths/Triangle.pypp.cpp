...
void register_Triangle_class(){
    ...
    { //::SireMaths::Triangle
        typedef bp::class_< SireMaths::Triangle, bp::bases< Siren::Primitive<SireMaths::Triangle> > > Triangle_exposer_t;
        ...
        { //::SireMaths::Triangle::hashCode
        
            typedef ::uint ( ::SireMaths::Triangle::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireMaths::Triangle::hashCode );
        ...
        { //::SireMaths::Triangle::operator=
            ...
            typedef ::SireMaths::Triangle & ( ::SireMaths::Triangle::*assign_function_type )( ::SireMaths::Triangle const & ) ;
            assign_function_type assign_function_value( &::SireMaths::Triangle::operator= );
        ...
        Triangle_exposer.def( bp::self == bp::self );
        { //::SireMaths::Triangle::operator[]
        ...
        { //::SireMaths::Triangle::stream
        
            typedef void ( ::SireMaths::Triangle::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireMaths::Triangle::stream );
