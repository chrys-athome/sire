...
void register_Sum_class(){
    ...
    { //::SireCAS::Sum
        typedef bp::class_< SireCAS::Sum, bp::bases< SireCAS::CASNode, Siren::Object > > Sum_exposer_t;
        ...
        Sum_exposer.def( bp::init< QList< SireCAS::Expression > const & >(( bp::arg("expressions") )) );
        Sum_exposer.def( bp::init< SireCAS::Sum const & >(( bp::arg("other") )) );
        { //::SireCAS::Sum::children
        
            typedef ::QList< SireCAS::Expression > ( ::SireCAS::Sum::*children_function_type )(  ) const;
        ...
        { //::SireCAS::Sum::hashCode
        
            typedef ::uint ( ::SireCAS::Sum::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireCAS::Sum::hashCode );
        ...
        Sum_exposer.def( bp::self != bp::self );
        { //::SireCAS::Sum::operator=
        
            typedef ::SireCAS::Sum & ( ::SireCAS::Sum::*assign_function_type )( ::SireCAS::Sum const & ) ;
            assign_function_type assign_function_value( &::SireCAS::Sum::operator= );
        ...
        { //::SireCAS::Sum::stream
            ...
            typedef void ( ::SireCAS::Sum::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireCAS::Sum::stream );
        ...
        { //::SireCAS::Sum::symbols
            ...
            typedef ::QSet< SireCAS::Symbol > ( ::SireCAS::Sum::*symbols_function_type )(  ) const;
        ...
        { //::SireCAS::Sum::test
            ...
            typedef bool ( ::SireCAS::Sum::*test_function_type )( ::Siren::Logger & ) const;
            test_function_type test_function_value( &::SireCAS::Sum::test );
