...
void register_Promise_class(){
    ...
    { //::SireCluster::Promise
        typedef bp::class_< SireCluster::Promise, bp::bases< Siren::Handle > > Promise_exposer_t;
        ...
        { //::SireCluster::Promise::hashCode
        
            typedef ::uint ( ::SireCluster::Promise::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireCluster::Promise::hashCode );
        ...
        { //::SireCluster::Promise::input
            ...
            typedef ::SireCluster::WorkPacketPtr ( ::SireCluster::Promise::*input_function_type )(  ) ;
        ...
        { //::SireCluster::Promise::interimResult
            ...
            typedef ::SireCluster::WorkPacketPtr ( ::SireCluster::Promise::*interimResult_function_type )(  ) ;
        ...
        { //::SireCluster::Promise::result
            ...
            typedef ::SireCluster::WorkPacketPtr ( ::SireCluster::Promise::*result_function_type )(  ) ;
        ...
        { //::SireCluster::Promise::runLocal
        
            typedef ::SireCluster::Promise ( *runLocal_function_type )( ::SireCluster::WorkPacket const & );
            runLocal_function_type runLocal_function_value( &::SireCluster::Promise::runLocal );
        ...
        { //::SireCluster::Promise::toString
        
            typedef ::QString ( ::SireCluster::Promise::*toString_function_type )(  ) const;
            toString_function_type toString_function_value( &::SireCluster::Promise::toString );
        ...
        Promise_exposer.staticmethod( "runLocal" );
        Promise_exposer.def( "__copy__", &__copy__);
        Promise_exposer.def( "__deepcopy__", &__copy__);
        Promise_exposer.def( "clone", &__copy__);
        Promise_exposer.def( "__str__", &__str__< ::SireCluster::Promise > );
        Promise_exposer.def( "__repr__", &__str__< ::SireCluster::Promise > );
    }
