...
void register_LinkToProperty_class(){
    ...
    { //::SireBase::LinkToProperty
        typedef bp::class_< SireBase::LinkToProperty, bp::bases< Siren::Object > > LinkToProperty_exposer_t;
        ...
        { //::SireBase::LinkToProperty::hashCode
        
            typedef ::uint ( ::SireBase::LinkToProperty::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireBase::LinkToProperty::hashCode );
        ...
        LinkToProperty_exposer.def( bp::self == bp::self );
        { //::SireBase::LinkToProperty::stream
        
            typedef void ( ::SireBase::LinkToProperty::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireBase::LinkToProperty::stream );
