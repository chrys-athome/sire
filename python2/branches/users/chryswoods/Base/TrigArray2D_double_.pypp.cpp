...
void register_TrigArray2D_double__class(){
    ...
    { //::SireBase::TrigArray2D< double >
        typedef bp::class_< SireBase::TrigArray2D< double >, bp::bases< Siren::Mutable, SireBase::TrigArray2DBase, Siren::Object > > TrigArray2D_double__exposer_t;
        ...
        { //::SireBase::TrigArray2D< double >::stream
        
            typedef SireBase::TrigArray2D< double > exported_class_t;
            typedef void ( ::SireBase::TrigArray2D< double >::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireBase::TrigArray2D< double >::stream );
        ...
        { //::SireBase::TrigArray2D< double >::typeName
        
            typedef SireBase::TrigArray2D< double > exported_class_t;
            typedef ::QString ( *typeName_function_type )(  );
            typeName_function_type typeName_function_value( &::SireBase::TrigArray2D< double >::typeName );
        ...
        TrigArray2D_double__exposer.staticmethod( "typeName" );
