...
void register_MemInfo_class(){
    ...
    { //::SireBase::MemInfo
        typedef bp::class_< SireBase::MemInfo, bp::bases< Siren::Handle > > MemInfo_exposer_t;
        ...
        { //::SireBase::MemInfo::hashCode
        
            typedef ::uint ( ::SireBase::MemInfo::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireBase::MemInfo::hashCode );
