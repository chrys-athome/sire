...
#include "convertproperty.hpp"

using boost::python::register_tuple;

void register_SireBase_containers()
{
    register_property_container<SireBase::Property,SireBase::PropertyBase>();
    register_property_container<SireBase::StringMangler,SireBase::StringManglerBase>();
}
