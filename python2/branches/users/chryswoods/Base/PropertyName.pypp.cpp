...
void register_PropertyName_class(){
    ...
    { //::SireBase::PropertyName
        typedef bp::class_< SireBase::PropertyName, bp::bases< Siren::Object > > PropertyName_exposer_t;
        ...
        PropertyName_exposer.def( bp::init< QString const &, Siren::Object const & >(( bp::arg("source"), bp::arg("default_value") )) );
        PropertyName_exposer.def( bp::init< Siren::Object const & >(( bp::arg("value") )) );
        ...
        { //::SireBase::PropertyName::hashCode
        
            typedef ::uint ( ::SireBase::PropertyName::*hashCode_function_type )(  ) const;
            hashCode_function_type hashCode_function_value( &::SireBase::PropertyName::hashCode );
        ...
        { //::SireBase::PropertyName::stream
        
            typedef void ( ::SireBase::PropertyName::*stream_function_type )( ::Siren::Stream & ) ;
            stream_function_type stream_function_value( &::SireBase::PropertyName::stream );
        ...
        { //::SireBase::PropertyName::value
            ...
            typedef ::Siren::Object const & ( ::SireBase::PropertyName::*value_function_type )(  ) const;
