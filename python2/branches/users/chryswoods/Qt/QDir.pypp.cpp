...
void register_QDir_class(){
    ...
    { //::QDir
        ...
        QDir_exposer.def( bp::init< QString const &, QString const &, bp::optional< QFlags< QDir::SortFlag >, QFlags< QDir::Filter > > >(( bp::arg("path"), bp::arg("nameFilter"), bp::arg("sort")=::QFlags<QDir::SortFlag>( QFlag(16) ), bp::arg("filter")=AllEntries )) );
        ...
        { //::QDir::entryInfoList
            ...
            QDir_exposer.def( 
                ...
                , ( bp::arg("filters")=NoFilter, bp::arg("sort")=NoSort ) );
        ...
        { //::QDir::entryInfoList
            ...
            QDir_exposer.def( 
                "entryInfoList"
                , entryInfoList_function_type( &::QDir::entryInfoList )
                , ( bp::arg("nameFilters"), bp::arg("filters")=NoFilter, bp::arg("sort")=NoSort ) );
