...
public:
    ...
    ResNumList residuesBondedTo() const;
    ResNumList residuesBondedTo(const QString &atom) const;
    
    bool bondedTo(ResNum resnum) const;
    bool bonded(const AtomIndex &atom0, const AtomIndex &atom1) const;
    
    BondList interBonds() const;
    BondList intraBonds() const;
    BondList asymmetricBonds() const;
    ...
    BondList bonds(const QString &atomname) const;
    BondList interBonds(const QString &atomname) const;
    BondList intraBonds(const QString &atomname) const;

    BondList bonds(ResNum rnum) const;

    AtomIndexSet anchors() const;
...
ResNumList ResidueBondsPvt::residuesBondedTo() const
{
    return bondedres.keys();
}

/** Return the list of residue numbers of all residues bonded to the atom 'atom' */
ResNumList ResidueBondsPvt::residuesBondedTo(const QString &atom) const
{
    ResNumList resnums;
...
AtomIndexSet ResidueBondsPvt::anchors() const
{
    AtomIndexSet ancs;
...
AtomIndexSet ResidueBondsPvt::atoms() const
{
    //get the anchor atoms
    AtomIndexSet ancs = anchors();
...
BondList ResidueBondsPvt::bonds(const QString &atomname) const
{
...
/** Return the list of inter-residue bonds that involve the atom called 'atomname' in 
    this residue */
BondList ResidueBondsPvt::interBonds(const QString &atomname) const
{
    BondList bnds;
...
/** Return the list of intra-residue bonds that involve the atom called 'atomname' in 
    ...
    to this atom. */
BondList ResidueBondsPvt::intraBonds(const QString &atomname) const
{
    BondList bnds;
...
BondList ResidueBondsPvt::bonds(ResNum rnum) const
{
    if (resnum == rnum)
    {
...
BondList ResidueBondsPvt::asymmetricBonds() const
{
    BondList bonds = intraBonds();
...
ResNumList ResidueBonds::residuesBondedTo() const
{
    return d->residuesBondedTo();
}

ResNumList ResidueBonds::residuesBondedTo(const QString &atom) const
{
...
BondList ResidueBonds::interBonds() const
{
    return d->interBonds();
}

BondList ResidueBonds::intraBonds() const
{
    return d->intraBonds();
}

BondList ResidueBonds::asymmetricBonds() const
{
    return d->asymmetricBonds();
}

BondList ResidueBonds::bonds() const
{
    return d->bonds();
}
...
BondList ResidueBonds::bonds(const QString &atomname) const
{
    return d->bonds(atomname);
}

BondList ResidueBonds::interBonds(const QString &atomname) const
{
    return d->interBonds(atomname);
}

BondList ResidueBonds::intraBonds(const QString &atomname) const
{
    return d->intraBonds(atomname);
}

BondList ResidueBonds::bonds(ResNum rnum) const
{
    return d->bonds(rnum);
}

AtomIndexSet ResidueBonds::anchors() const
{
    return d->anchors();
}

AtomIndexSet ResidueBonds::atoms() const
{
    return d->atoms();
}
