...
ParameterTable wrap_assign_b3(const assign_parameters &assigner, const ParameterTable &orig_table,
                              ParameterDB &database, const MatchMRData &matchmr)
{
    return assigner.assign(orig_table, database, matchmr);
}

ParameterTable wrap_assign_b2(const assign_parameters &assigner, const ParameterTable &orig_table,
                              ParameterDB &database)
{
    return assigner.assign(orig_table, database);
}
