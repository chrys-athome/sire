...
static const RegisterMetaType<AssignInstruction> r_instruc(
                                        "SireDB::AssignInstruction", MAGIC_ONLY);
...
static const RegisterMetaType<using_database> r_database(
                                        "SireDB::using_database", MAGIC_ONLY);
...
static const RegisterMetaType<using_relationships_base> r_relate(
                                        "SireDB::using_relationships_base");
