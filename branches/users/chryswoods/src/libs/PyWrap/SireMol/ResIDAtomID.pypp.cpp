...
void register_ResIDAtomID_class(){
    ...
    bp::class_< SireMol::ResIDAtomID >( "ResIDAtomID", bp::init< bp::optional< SireMol::ResID, SireMol::AtomID > >(( bp::arg("resid")=::SireMol::ResID( 0 ), bp::arg("atmid")=::SireMol::AtomID( 0 ) )) )    
        ...
        .def( 
            "atomID"
            , (::SireMol::AtomID ( ::SireMol::ResIDAtomID::* )(  ) const)( &::SireMol::ResIDAtomID::atomID ) )    
        .def( bp::self != bp::self )    
        .def( bp::self < bp::self )    
        .def( bp::self <= bp::self )    
        .def( bp::self == bp::self )    
        ...
        .def( 
            "resID"
            , (::SireMol::ResID ( ::SireMol::ResIDAtomID::* )(  ) const)( &::SireMol::ResIDAtomID::resID ) )    
        .def( 
            "toString"
            , (::QString ( ::SireMol::ResIDAtomID::* )(  ) const)( &::SireMol::ResIDAtomID::toString ) );
