...
public:
   ...
   //////// Memory management //////////////////////
    void detach();
    EditMolData deepCopy() const;
    EditMolData shallowCopy();
    
    EditRes extract(ResNum resnum) const;
   /////////////////////////////////////////////////

   
   //////// Interfacing with EditMol and EditRes ///
    EditMol editmol();
    EditRes editres(ResNum resnum);
    EditRes editres(const QString &resname);
   ...
   //////// Querying the molecule //////////////////
    ...
    EditResSet residuesBondedTo(ResNum resnum);
