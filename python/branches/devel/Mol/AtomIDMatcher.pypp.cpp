...
void register_AtomIDMatcher_class(){
    ...
    { //::SireMol::AtomIDMatcher
        ...
        AtomIDMatcher_exposer_t AtomIDMatcher_exposer = AtomIDMatcher_exposer_t( "AtomIDMatcher", bp::init< >() );
        bp::scope AtomIDMatcher_scope( AtomIDMatcher_exposer );
        AtomIDMatcher_exposer.def( bp::init< QList< QPair< QString, QString > > const & >(( bp::arg("match_names") )) );
        AtomIDMatcher_exposer.def( bp::init< QList< QPair< int, int > > const & >(( bp::arg("match_idxs") )) );
        AtomIDMatcher_exposer.def( bp::init< QList< QPair< SireMol::AtomIdentifier, SireMol::AtomIdentifier > > const & >(( bp::arg("match_ids") )) );
        ...
        { //::SireMol::AtomIDMatcher::match
        
            typedef ::QHash< SireMol::AtomIdx, SireMol::AtomIdx > ( ::SireMol::AtomIDMatcher::*match_function_type )( ::SireMol::MoleculeInfoData const &,::SireMol::MoleculeInfoData const & ) const;
            match_function_type match_function_value( &::SireMol::AtomIDMatcher::match );
        ...
        { //::SireMol::AtomIDMatcher::match
            ...
            typedef ::QHash< SireMol::AtomIdx, SireMol::AtomIdx > ( ::SireMol::AtomIDMatcher::*match_function_type )( ::SireMol::MoleculeView const &,::SireBase::PropertyMap const &,::SireMol::MoleculeView const &,::SireBase::PropertyMap const & ) const;
            match_function_type match_function_value( &::SireMol::AtomIDMatcher::match );
