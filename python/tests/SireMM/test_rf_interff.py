...
old_clusterff.setUseReactionField(True)
old_clusterff.setReactionFieldDielectric(dielectric)
...
old_fixedff.setUseReactionField(True)
old_fixedff.setReactionFieldDielectric(dielectric)
...
new_clusterff.setProperty("cljFunction", cljfunc)
...
def test_energy(verbose = False):
    ...
    cljfunc = CLJRFFunction(coul_cutoff, lj_cutoff)
    cljfunc.setDielectric(dielectric)
