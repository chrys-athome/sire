...
void ClustersWidget::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
   int alpha = 255;
...
void ClustersWidget::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
   /*
...
void ClustersWidget::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
