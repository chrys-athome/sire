...
namespace Siren
{
    ...
    */
    ...
    public:
        ...
        Class(const Qt::String &type_name);
        ...
        bool implements(const Qt::String &type_name) const;
        bool implements(const char* type_name) const;

        template<class T>
        bool implements() const;
        
        Qt::StringList interfaces() const;
        ...
        bool canCast(const Qt::String &classname) const;
        bool canCast(const char *classname) const;

        void assertCanCast(const Qt::String &classname) const;
        ...
        static Qt::StringList registeredTypes();
