...
namespace Siren
{
    namespace Qt
    {
        ...
        typedef QStringListIterator StringListIterator;
        typedef QMutableStringListIterator MutableStringListIterator;
        ...
        struct MultiHash
        {
            typedef QMultiHash<Key,Value> Type;
            typedef QMutableHashIterator<Key,Value> MutableIterator;
            typedef QHashIterator<Key,Value> Iterator;
            typedef typename QMultiHash<Key,Value>::iterator iterator;
            typedef typename QMultiHash<Key,Value>::const_iterator const_iterator;
        };
